...
from .views import PlantsList, PlantList, PlantList2, PlantList4, BlocksList, BlockView, impressum, random_plant, compliance, widmung, niemehrrwe, friends, calculations, downloads
...
urlpatterns = [
    ...
    path('niemehrrwe', niemehrrwe, name="niemehrrwe"),
