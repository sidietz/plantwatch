...
sqlite3 plantwatch.db  "CREATE TABLE blocks(plantid TEXT, blockid TEXT NOT NULL PRIMARY KEY, federalstate TEXT, energysource TEXT, initialop INTEGER, chp TEXT, blockname TEXT, netpower REAL, state TEXT, endop TEXT, company TEXT, fullload REAL, ophours REAL, FOREIGN KEY (blockid) REFERENCES addresses(blockid) ON DELETE CASCADE);"
